...
public class SysTenantServiceImpl implements ISysTenantService {
    ...
    public SysTenantVo queryById(Long id) {
        return sysTenantMapper.selectVoById(id);
    }
    ...
    public SysTenantVo queryByTenantId(String tenantId) {
        return sysTenantMapper.selectVoOne(new LambdaQueryWrapper<SysTenant>().eq(SysTenant::getTenantId, tenantId));
    }
    ...
    public TableDataInfo<SysTenantVo> queryPageList(SysTenantBo bo, PageQuery pageQuery) {
        ...
        Page<SysTenantVo> result = sysTenantMapper.selectVoPage(pageQuery.build(), lqw);
    ...
    public List<SysTenantVo> queryList(SysTenantBo bo) {
        LambdaQueryWrapper<SysTenant> lqw = buildQueryWrapper(bo);
        return sysTenantMapper.selectVoList(lqw);
    }
    ...
    public Boolean insertByBo(SysTenantBo bo) {
        ...
        boolean flag = sysTenantMapper.insert(add) > 0;
        if (!flag) {
    ...
    public Boolean deleteWithValidByIds(Collection<Long> ids, Boolean isValid) {
        ...
        return sysTenantMapper.deleteBatchIds(ids) > 0;
    }
    ...
    public boolean checkCompanyNameUnique(SysTenantBo bo) {
        boolean exist = sysTenantMapper.exists(new LambdaQueryWrapper<SysTenant>()
